...
|---|---|---|
| ML in Astronomy | Build a Convolutional Neural Network in PyTorch to classify galaxy morphologies (Galaxy Zoo 2 dataset) on Google Colab. | [ML-Astronomy/](ML-Astronomy/) |
